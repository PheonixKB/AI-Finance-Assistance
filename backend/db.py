...
dbconfig = {
    ...
    "user": os.getenv("DB_USER", "root"),     # Database user, defaults to 'root'
    "password": os.getenv("DB_PASSWORD"), # Database password
    "database": os.getenv("DB_NAME", "finance_assistant"), # Database name, defaults to 'finance_assistant'
...
connection_pool = pooling.MySQLConnectionPool(
    pool_name="finance_pool",        # Name of the connection pool
